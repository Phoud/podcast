    ...
    <div class="container-fluid dashboard-content ">
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h2 class="pageheader-title">ແກ້ໄຂຂໍ້ມູນສຽງ</h2>
                </div>
            </div>
        </div>
        <div class="ecommerce-widget">
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <form action="{{ route('admin.updatePodcast', $update->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="modal-body">
                                ...
                                <div class="file-upload" id="file-upload_videos">
                                    <div class="file-select" style="border-radius: 5px;">
                                        ...
                                        <input type="file" name="podcast" id="chooseFile">
                                    </div>
                                </div><br>
                                ...
                                <br>
                                <button class="btn btn-success" style="border-radius:5px;" type="submit">ແກ້ໄຂ ໄຟລສຽງ</button>
                            </div>
                        </form>
                    </div>
                </div>
