        ...
        <div class="container-fluid dashboard-content ">
            ...
            <div class="ecommerce-widget">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <form action="{{ route('admin.insert.blog') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="modal-body">
                                    <label class="lbname">ຫົວຂໍ້ຂ່າວ</label>
                                    <input type="text" class="form-control" placeholder="ກະລຸນາປ້ອນຫົວຂໍ້..." name="title"><br>
                                    ...
                                    <label class="lbname">ລາຍລະອຽດຂອງຂ່າວ</label>
                                        ...
                                        <br>
                                    <button class="btn btn-success m-t-30" style="border-radius:5px;" type="submit">ເພີ່ມ</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
$("#imgInp").change(function(){
    ...
    <script>
        ...
        $(document).ready(function(){
            $('#tags').select2({
                placeholder: "ກະລຸນາເລືອກເພີ່ມ ຫຼື ເລືອກແທັກ",
                tags: true
            });
        })
    </script>
