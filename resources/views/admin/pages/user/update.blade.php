            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">ແກ້ໄຂຜູ້ໃຊ້</h2>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card">
                            <form action="{{ route('userUpdate', $user->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="modal-body">
                                    ...
                                    <input type="text" value="{{ $user->name }}" class="form-control" required name="name"><br>
                                    <label class="lbname">ທີ່ຢູ່ອີເມວ</label>
                                    <input type="email" value="{{ $user->email }}" class="form-control" required name="email"><br>
                                    <label class="lbname">ລະຫັດຜ່ານ</label>
                                    <input type="password" id="NewPassword" class="form-control" name="password"><br>
                                    ...
                                    <div class="form-group">
                                        <img style="max-height: 150px;" id="blah" src="{{ url('/') }}/home/images/{{ $user->profile }}" alt="your image"/>
                                    </div>
                                    <br>
