...
<div class="home">
		...
		<div class="home_container d-flex flex-column align-items-center justify-content-center">
			<div class="home_content">
				<div class="home_title"><h1>ແກ້ໄຂຂໍ້ມູນໂປຣຟາຍ</h1></div>
			</div>
		</div>
	</div>
			...
			<div class="row">
				<div class="col">
					...
					<div class="contact_form_container">
						<div class="contact_form_title text-center">ແກ້ໄຂຂໍ້ມູນສ່ວນຕົວ</div>
					...
					@endif
								<form action="{{ route('profileUpdate', $update->id) }}" enctype="multipart/form-data" class="contact_form" method="POST">
									@csrf
									<div class="row">
										<div class="col-md-6 contact_col">
											<label for="name">ຊື່ ແລະນາມສະກຸນ</label>
											<input type="text" class="contact_input" placeholder="ຊື່" name="name" value="{{ $update->name }}" required="required">
										</div>
										<div class="col-md-6">
											<label for="name">ທີ່ຢູ່ອີເມວ</label>
											<input type="email" class="contact_input" placeholder="ທີ່ຢູ່ອີເມວ" value="{{ $update->email }}" name="email" required="required">
										</div>
									</div>
									<div>
                                ...
                                <div class="form-group">
                                    <img style="max-height: 150px;" id="blah" src="{{ url('/') }}/home/images/{{ $update->profile }}" alt="cover"/>
                                </div>
									<button class="contact_button button_fill ml-auto mr-auto">ແກ້ໄຂ</button>
								</form>
							</div>
						</div>	
					</div>
